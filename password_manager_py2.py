...
import tkMessageBox #imports a message box which will be used in the openList function.
...
def openList(): #Defines the function openList, used for the second button.
    ...
    tkMessageBox.showinfo("Names and passwords", getdata) #Makes the gui that shows our names and passwords.
